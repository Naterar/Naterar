...
**Systems** `Linux` `Windows` `Git` `VS Code`
**Cloud & Security** `AWS` `Azure` `Microsoft Sentinel` `Defender XDR` `Tenable` `MITRE ATT&CK`
**In progress** `pytest` `Django`
